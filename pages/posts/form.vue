<template>
  <h1 class="text-2xl font-semibold text-gray-900">
    一个文本框输入placeholder上移的效果
  </h1>
  <form class="mt-8 w-1/2" action="" method="POST">
    <div class="relative">
      <input
        id="email"
        name="email"
